    ...
    <main class={styles.pageShell}>
      ...
      <section id="intro_screen" class={`${styles.section} ${styles.hero}`}>
        ...
        <div class={styles.heroCopy}>
          ...
          <p class={styles.lede}>
            Turning ideas into usable, well-built web apps from front-end to
            back-end
          </p>
          <div class={styles.socialLinks}>
            <a
              href="https://www.linkedin.com/in/benjamin-jenkyn/"
              target="linkedin"
            ...
            <a
              href="https://github.com/BenJenkyn"
              target="_blank"
              rel="noopener noreferrer"
              class={styles.socialLink}
              aria-label="GitHub"
      ...
      <section
        id="work_projects"
        class={`${styles.section} ${styles.workSection}`}
      >
        ...
        <div class={styles.glassBoxSection}>
          <GlassBox
            ...
            projectDescription={
              <>
                This website was a campaign by lunchables where kids could make
                their own lunchable creation, scan it, and then put it in the
                game where they could play against others to try and get a high
                score. I worked on the website and the tool to scan the
                Lunchable’s creation.
                <br />
                <br />
                Unfortunately the site has been taken down as the campaign is
                over but I have provided a link to the wayback machine so you
                can see what the home page looked like when it was running.
              </>
            }
          ...
          <GlassBox
            ...
            projectDescription={
              <>
                ...
                art for the game was made using free asset packs, the links for
                which can be found in the GitHub.
                <br />
                <br />
                (Please note that if you want to play the game that you will
                need to use a browser on the desktop as it will not work
                properly on mobile.)
              </>
            }
            websiteLink="https://spetsai.itch.io/hollow-head"
            githubLink="https://github.com/BenJenkyn/interactive-media-final-project"
            techStack={[{ icon: <SiGodotengine size="32px" />, name: 'Godot' }]}
          />
          <GlassBox
      ...
      >
        ...
        <div class={styles.glassBoxSection}>
          <GlassBox
            ...
            projectDescription={
              <>
                This was a game made during a game jam that a team of 2 others
                and I worked on for TOJam 2025. We had 3 days to work on the
                game and the theme was "The more there is the worse it gets". It
                was a lot of fun working on the team and trying to get the game
            ...
            techStack={[{ icon: <SiUnity size="32px" />, name: 'Unity' }]}
          />
          <GlassBox
